...
public class RoadObject extends GameObject {
    ...
    /**
     * Метод, отвечающий за передвижение препятствия. У препятствия может быть своя скорость
     * и дополнительная,
    ...
    /**
     * Проверяет текущий объект и объект, который пришел в качестве параметра,
     * на пересечение их изображений
     * с учетом дистанции distance.
     * Например, если в качестве distance передать число 12,
     * а 2 объекта расположены друг от друга на расстоянии меньшем,
